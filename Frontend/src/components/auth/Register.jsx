...
export const Register = ({ setCurrentView, closeAuthModal }) => {
  ...
  return (
    <div className="w-full max-w-xl mx-auto bg-white p-2">
      <div className="text-center mb-6">
        <h2 className="text-2xl font-extrabold text-stone-900 tracking-tight mb-1">
          Join Swasthya Sanchar AI
        </h2>
        <p className="text-xs text-stone-600">
          Empowering rural healthcare communication. Select your role to begin.
        </p>
      </div>
        ...
        <div className="space-y-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            >
              ...
              <div className="font-extrabold text-stone-900 text-sm mb-1">Patient</div>
            ...
            >
              ...
              <div className="font-extrabold text-stone-900 text-sm mb-1">ASHA Worker</div>
              <div className="text-xs text-stone-600 leading-relaxed">
            ...
            >
              <div className="text-3xl mb-2">👨‍⚕️</div>
              <div className="font-extrabold text-stone-900 text-sm mb-1">Doctor</div>
              <div className="text-xs text-stone-600 leading-relaxed">
            ...
            >
              <div className="text-3xl mb-2">👨‍👩‍👧</div>
              <div className="font-extrabold text-stone-900 text-sm mb-1">Caregiver</div>
              <div className="text-xs text-stone-600 leading-relaxed">
          ...
          <button
            onClick={() => setStep(1)}
            className="w-full bg-orange-600 hover:bg-orange-700 text-white font-bold text-sm py-3.5 rounded-xl shadow-md transition-all cursor-pointer mt-2"
          >
            ...
            <div className="space-y-3">
              ...
              <div className="flex gap-3 pt-2">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-2/3 bg-orange-600 hover:bg-orange-700 text-white font-bold text-xs py-3 rounded-xl shadow-md transition-all cursor-pointer disabled:opacity-50"
                >

      ...
      {selectedDoc && (
        ...
        >
          <div className="glass-card" style={{ width: '100%', maxWidth: '700px', maxHeight: '90vh', overflowY: 'auto' }}>
            ...
            {/* OCR Extracted Content & Voice Explanation */}
            <div style={{ marginBottom: '16px' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '12px', flexWrap: 'wrap', gap: '8px' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                  ...
                  <button
                    className="btn-demo"
                    onClick={() => handleSpeakText(selectedDoc.translated_text || selectedDoc.text_content, selectedAudioLang)}
            ...
            {selectedDoc.translated_text && (
              <div style={{ marginBottom: '16px' }}>
                <h4 style={{ fontSize: '14px', color: '#2dd4bf', marginBottom: '8px' }}>🌐 AI Language Translation</h4>
                <div
                  style={{

...
class ReminderSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'title', 'notes', 'time', 'start_date', 'end_date',
        ...
        read_only_fields = ['id', 'patient_id', 'medication_id', 'created_by', 'created_at', 'updated_at', 'last_sent', 'next_run', 'acknowledged_at', 'caregiver_notified_at']
